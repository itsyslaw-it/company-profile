          ...
          <div className="space-y-6">
            ...
            <div>
              <input
                type="email"
                placeholder="Email"
                className="w-full px-4 placeholder-[#131D2D]/50 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-amber-600"
              />
            </div>
            <div>
              <input
            ...
            <div>
              <button className="w-full cursor-pointer bg-amber-600 text-white px-4 py-3 rounded-lg hover:bg-amber-700 transition-colors">
                Send Message
              </button>
            </div>
          </div>
