      ...
      <div className="container mx-auto px-6">
        ...
        <div className="w-full flex md:justify-end gap-12 relative">
          <motion.div
            ...
            className="md:absolute relative md:left-[10%] top-2/12 h-fit w-full md:w-1/2 bg-[#131D2D] md:bg-transparent text-white md:bg-gradient-to-r md:from-[#131D2D] md:via-[#131D2D]/90 md:to-black/30 p-8">
